...
const ContactUs = (props: Props) => {
	...
	return (
		<section id="contact-us" className="mx-auto w-5/6 pt-24 pb-32">
			<motion.div className="mx-auto w-5/6" onViewportEnter={() => props.setSelectedPage(SelectedPage.ContactUs)}>
				{/* HEADER */}
				<motion.div
					className="md:w-3/5"
					initial="hidden"
				...
				<div className="mt-10 justify-between gap-8 md:flex">
					<motion.div
						...
						<form target="_blank" onSubmit={onSubmit} action="https://formsubmit.co/ce8431df8946e7d4d2f2c85d29c496eb" method="POST" >
							<input
